...
public interface CashierOperations {
    ...
    @Operation(operationId = "listPhotos", summary = "Список кассиров")
    @ApiResponses(value = {
    ...
    @Operation(operationId = "list", summary = "Получить кассира по идентификатору")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Кассир",
                    content = {@Content(mediaType = "application/json",
    ...
    @Operation(operationId = "deletePhoto", summary = "Добавить кассира",
    ...
    @Operation(operationId = "deletePhoto", summary = "Обновить кассира",
            security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Кассир",
                    content = {@Content(mediaType = "application/json",
    ...
    @Operation(operationId = "list", summary = "Удалить кассира по идентификатору")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Кассир",
                    content = {@Content(mediaType = "application/json",
                            schema = @Schema(implementation = CashierDto.class))}),
