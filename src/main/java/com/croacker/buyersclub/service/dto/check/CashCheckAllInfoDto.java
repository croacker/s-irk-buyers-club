...
/**
 * Чек, полная информация.
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
@Accessors(chain = true)
@Schema(description = "Чек, полная информация")
public class CashCheckAllInfoDto {
    /**
     * Идентификатор.
     */
     ...
     * Имя кассира.
     */
    @Schema(description = "Имя кассира", example = "cashier name")
     ...
     */
    @Schema(description = "Наименование магазина", example = "shop name")
     ...
     * Наименование магазина.
     */
    @Schema(description = "Наименование организации", example = "organization name")
